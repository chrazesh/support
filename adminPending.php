...
<div class="col-4 mb-2" >
  ...
  <textarea  cols="45" rows="3"  placeholder="Feedback" class="form-control"  id="supportFeedback" name="feedback" disabled></textarea>
 </div>
  ...
  <div class="modal fade" id="exampleModal"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content" style="height:95vh;overflow:scroll;">
            ...
            <?php  
            $con = dbConnection();
            $select="select * from issue where client_status='Open' and assigned='1' and assigned_officer='".$_SESSION['username']."'order by date desc";
            $query=mysqli_query($con, $select);
            $i=1;
            while( $result = mysqli_fetch_assoc($query)){
              ?>
              <tr class="clstrCustomer"  data-company="<?php echo $result['companyName']?>"  data-issue="<?php echo $result['issue']?>" data-assigned="<?php echo $result['assigned_officer']?>" data-id="<?php echo $result['id']?>" data-cusId="<?php echo $result['customerId']?>">       
                    <td><?php echo $i?></td>
...
<div class="mx-4 heading">
  ...
  <button type="button" class="btn btn-primary mx-2 btnAdd">ADD</button>
    ...
    <div class="fromTo text-center">
      ...
      <input type="button"  value="Search" onclick="GetReportBy('adminPending')">
      <!--<select style="padding:3px;"  >-->
      <!--    <option style="display:none">Select</option>-->
      <!--    <option onclick="GetReportBy1('open1')" value="open" id="record2Open">Open</option>-->
      <!--    <option onclick="GetReportBy1('close1')" value="close" id="record2Close">Close</option>-->
...
//  echo $r['support_staff'];

$select="select * from issue where client_status='Open' and assigned='1' " ;
$query=mysqli_query($con, $select);
$i=1;
while( $result = mysqli_fetch_assoc($query)){
  ?>
   ...
   $("#supportCompany1").val($(this).attr("data-company") );
    ...
    $("#supportStaff").val($(this).attr("data-assigned") );
      $("#id").val($(this).attr("data-id") );
       $("#cusId").val($(this).attr("data-cusId") );
