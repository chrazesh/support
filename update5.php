...
$con = dbConnection();
$id=$_GET['id'];
$select="select * from renew where id='$id'";
...
if(isset($_POST['update2'])){
    ...
    $updatequery="update renew set company_name='$companyname', client_name='$sname',phone='$sphone',email='$semail',address='$saddress',call_by='$scall',support_staff='$ssupport',date='$sdate',forward='$forward',priority='$priority',attachment='$pname',timePeriod='$timePeriod',feedback='$feedback',remote_onsite='$sremote',status='$sstatus',user='$user',entryDate=now() where id='$id'";
...
<div class="col-4 mb-2">
   ...
   <div class="col-4 mb-2">
       ...
       <input type="text" placeholder="Phone Number" class="form-control special2" name="sphone" value="<?php echo $result['phone'] ?>" required>
   </div>
...
<div class="col-4 mb-2">
  ...
  <input type="text" class="form-control special4" name="timePeriod" id="duration" value="<?php echo $result['timePeriod'] ?>" required>
 </div>
...
<?php
   ...
   <div class="col-4 mb-2">
    ...
    <select name="sstatus" class="form-control" value="<?php echo $result['status'] ?>" required>
