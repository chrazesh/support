...
<div class="col-4">
  ...
  <div class="input-group mb-3">
       <input type="text" placeholder="Company Name" class="form-control" name="companyname" value="<?php echo $result['company_name'] ?>" required>
...
<div class="col-4 mb-2">
       ...
       <input type="text" placeholder="Client Name" class="form-control" name="sname" value="<?php echo $result['client_name'] ?>" required>
   </div>

   <div class="col-4 mb-2">
    <label class="form-label">Call By</label>
     <input type="text" placeholder="Call By" class="form-control" name="scall" value="<?php echo $result['call_by'] ?>" required>
   </div>
</div>
...
<div class="row">
   ...
   <div class="col-4 mb-2">
    ...
    <input type="text" placeholder="Support Staff" class="form-control" name="ssupport" value="<?php echo $result['support_staff'] ?>" required>
   </div>
   <div class="col-4 mb-2">
    <label class="form-label">Date</label>
    <input type="date" id="defaultdate" class="form-control" name="sdate" value="<?php echo $result['date'] ?>" required>
   </div>

   <div class="col-4 mb-2" >
    <label class="form-label">Issue</label>
    <textarea id="" cols="45" rows="3"  placeholder="Issue" class="form-control" name="sissue" required><?php echo $result['issue'] ?></textarea>
   </div>
</div>
...
<div class="row">
   ...
   <div class="col-4 mb-2" >
    ...
    <textarea id="" cols="45" rows="3"  placeholder="Feedback" class="form-control" name="feedback" required><?php echo $result['feedback'] ?></textarea>
   </div>
   <div class="col-4 mb-2">
    ...
    <?php
      if($result['remote_onsite']=="Remote"){?>
         <option <?php $result['remote_onsite']=='Remote'?"selected":"" ?> value="Remote">Remote</option>
         <option value="Onsite">Onsite</option>
<?php
      }else{?>
        <option <?php $result['remote_onsite']=='Onsite'?"selected":"" ?> value="Onsite">Onsite</option>
