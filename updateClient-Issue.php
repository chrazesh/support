...
if(isset($_POST['Save'])){
  ...
  $semail=$_POST['email'];
  $insertquery="insert into issue(companyName,date,attachment,issue,user,entryDate) values('$companyname','$sdate','$pname','$sissue','$user',now())";
    // echo $insertquery;
...
<div class="container row">
    <div class="col-12 mb-2" >
      ...
      <textarea  rows="5" placeholder="Enter Your Issue Here" class="form-control"  id="supportIssue" name="sissue" required></textarea>
    </div>
    ...
    $passSelectCompany=mysqli_query($con,$selectCompany);
    $row=mysqli_fetch_assoc($passSelectCompany);  ?>
    <input type="email" name="email" value="<?php echo $row['email']?>" style="visibility:hidden;"></input>
...
<div class="fromTo text-center">
  ...
  <div class="mx-4" data-aos="zoom-in-up">
   ...
   <table class="display">
    ...
    //   $passSelectCompany=mysqli_query($con,$selectCompany);
    //   $row=mysqli_fetch_assoc($passSelectCompany);
      $select="select * from issue where user='".$_SESSION['username']."'";
      ...
      <tr>
        ...
        <td><a href="update2.php?id=<?php echo $result['id'] ?> " type="submit" class="bnone"><i class="fa-solid fa-pen-to-square"></i></a><a href="delete2.php?ids=<?php echo $result['id'] ?>" type="submit" class="bnone"><i class="fa-solid fa-trash" ></i></a></td>
